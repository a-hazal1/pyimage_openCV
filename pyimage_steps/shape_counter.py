...
# bağımsız değişken çözümleyiciyi oluştur ve bağımsız değişkenleri ayrıştır
...
# giriş görüntüsünü diskten yükle
image = cv2.imread(args["input"])

# görüntüyü gri tonlamaya dönüştür, bulanıklaştır ve eşikle
gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
blurred = cv2.GaussianBlur(gray, (5,5), 0)
thresh = cv2.threshold(blurred, 60, 255, cv2.THRESH_BINARY)[1]

# görüntüden konturları çıkar
